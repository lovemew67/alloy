...
import (
	...
	"github.com/grafana/alloy/internal/alloy/converter/diag"
	"github.com/grafana/alloy/internal/alloy/converter/internal/common"
	"github.com/grafana/alloy/internal/alloy/static/config"
	v1 "github.com/grafana/alloy/internal/alloy/static/integrations"
	agent_exporter "github.com/grafana/alloy/internal/alloy/static/integrations/agent"
	"github.com/grafana/alloy/internal/alloy/static/integrations/apache_http"
	"github.com/grafana/alloy/internal/alloy/static/integrations/azure_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/blackbox_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/cadvisor"
	"github.com/grafana/alloy/internal/alloy/static/integrations/cloudwatch_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/consul_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/dnsmasq_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/elasticsearch_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/gcp_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/github_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/kafka_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/memcached_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/mongodb_exporter"
	mssql_exporter "github.com/grafana/alloy/internal/alloy/static/integrations/mssql"
	"github.com/grafana/alloy/internal/alloy/static/integrations/mysqld_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/node_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/oracledb_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/postgres_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/process_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/redis_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/snmp_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/snowflake_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/squid_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/statsd_exporter"
	v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2"
	agent_exporter_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/agent"
	apache_exporter_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/apache_http"
	app_agent_receiver_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/app_agent_receiver"
	blackbox_exporter_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/blackbox_exporter"
	eventhandler_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/eventhandler"
	metricsutils_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/metricsutils"
	snmp_exporter_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/snmp_exporter"
	vmware_exporter_v2 "github.com/grafana/alloy/internal/alloy/static/integrations/v2/vmware_exporter"
	"github.com/grafana/alloy/internal/alloy/static/integrations/windows_exporter"
	"github.com/grafana/alloy/internal/alloy/static/logs"
	"github.com/grafana/alloy/internal/alloy/static/metrics"
	"github.com/grafana/alloy/internal/alloy/static/server"
	"github.com/grafana/alloy/internal/alloy/static/traces"
