...
import (
	...
	"github.com/grafana/alloy/internal/alloy/static/traces/spanmetricsprocessor/internal/cache"
)
...
func (p *processorImp) buildAttributes(serviceName string, span ptrace.Span, resourceAttrs pcommon.Map) pcommon.Map {
	...
	attr.PutStr(spanKindKey, spanKindStr(span.Kind()))
	attr.PutStr(statusCodeKey, statusCodeStr(span.Status().Code()))
